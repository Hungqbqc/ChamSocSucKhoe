...
export class BaoCaoThangActivity extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
  ...
  async tinhNgay(ngayChon) {
    ...
    for (
      ...
      khoangThoiGianHienThi.push(index.format('DD'));
    ...
    await this.setStateAsync({
      dauTuan: start,
      cuoiTuan: end,
      ngayChon: moment(ngayChon, DATE_FORMAT).format('MM/YYYY'),
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.thoiGian}>
          ...
          <View
            ...
            <Text>
              <Text style={{ fontSize: 18 }}> {this.state.ngayChon}</Text>
            </Text>
          </View>
          <View style={{ flex: 1 }}>
            <TouchableOpacity
